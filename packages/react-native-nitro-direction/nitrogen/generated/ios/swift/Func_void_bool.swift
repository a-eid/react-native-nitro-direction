...
/**
 * Wraps a Swift `(_ isRTL: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_bool {
  public typealias bridge = margelo.nitro.layoutdirection.bridge.swift

  private let closure: (_ isRTL: Bool) -> Void

  public init(_ closure: @escaping (_ isRTL: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(isRTL: Bool) -> Void {
    self.closure(isRTL)
  }
