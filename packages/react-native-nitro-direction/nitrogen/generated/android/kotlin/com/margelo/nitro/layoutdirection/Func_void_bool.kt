...
/**
 * Represents the JavaScript callback `(isRTL: boolean) => void`.
...
fun interface Func_void_bool: (Boolean) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(isRTL: Boolean): Unit
}
...
class Func_void_bool_cxx: Func_void_bool {
  ...
  @FastNative
  private external fun invoke_cxx(isRTL: Boolean): Unit
}
